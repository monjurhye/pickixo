...
const TITLE = 'জাতীয় বেতনস্কেল ২০২৬ — বেতন কত বাড়বে? | বেতন ক্যালকুলেটর';
const DESCRIPTION =
  'গেজেট-ভিত্তিক বেতন ক্যালকুলেটর। চাকরি (বেতন ও ভাতাদি) আদেশ, ২০২৬ অনুযায়ী '
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLd(
            breadcrumbSchema([
              { name: 'হোম', path: '/' },
              { name: 'বেতন ক্যালকুলেটর', path: PATH },
            ]),
